...
function cadastrarDespesa() {
    ...
    if (despesa.validarDados()) {
        ...
        document.getElementById('modal_titulo_style').className = "modal-header text-success"

        document.getElementById('modal_conteudo').innerHTML = 'Registro foi gravado com sucesso'
        ...
        document.getElementById('modal_titulo_style').className = "modal-header text-danger"
